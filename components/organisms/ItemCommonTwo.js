...
import { commonGroupsTwo, commonItemsTwo } from "~/helpers/navigationMaps";

class ItemCommonTwo extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <>    
        <ItemElementCommon
          ...
          groups={commonGroupsTwo}
          items={commonItemsTwo}
