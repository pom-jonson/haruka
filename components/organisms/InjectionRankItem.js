...
const InjectionRankItemWrapper = styled.div`
...
class InjectionRankItem extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    ...
    const h4_content = (
      <>
        ...
        />
        <div
          className="medicine_information"
          onClick={e => this.props.onAngleClicked(e, this.props.medicine.code)}
        >
...
export default InjectionRankItem;
