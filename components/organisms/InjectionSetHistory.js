...
import InjectionSetHistoryList from "../molecules/InjectionSetHistoryList";
...
function CheckArrayList(order_json) {
  ...
  if (order_json.params.injection.order_data) {
...
class InjectionSetHistory extends Component {
  state = {
...
InjectionSetHistory.contextType = Context;
InjectionSetHistory.defaultProps = {
  allPrescriptionOpen: null
};

InjectionSetHistory.propTypes = {
...
export default InjectionSetHistory;
