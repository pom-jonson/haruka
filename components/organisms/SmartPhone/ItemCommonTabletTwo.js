...
import { commonGroups_tabletTwo, commonTabletTwoItems } from "~/helpers/navigationMaps";

class ItemCommonTabletTwo extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <>    
        <ItemElementCommon
          ...
          groups={commonGroups_tabletTwo}
          items={commonTabletTwoItems}
...
export default ItemCommonTabletTwo;
