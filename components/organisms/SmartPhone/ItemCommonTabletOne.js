...
import { commonGroups_tabletOne, commonTabletOneItems } from "~/helpers/navigationMaps";

class ItemCommonTabletOne extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <>    
        <ItemElementCommon
          ...
          groups={commonGroups_tabletOne}
          items={commonTabletOneItems}
...
export default ItemCommonTabletOne;
