...
import InjectionRankItem from "./InjectionRankItem";
...
class InjectionRank extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleInjectionRankRender = (medicineRankData) => {
    this.setState({
      medicineRankData
    });
  }
