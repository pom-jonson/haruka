...
// class 
class CalcDial extends Component {
  ...
  async componentDidMount() {
    ...
    let _state = {};    
    if (this.props.calcInitData && this.props.calcInitData > 0) {      
    ...
    // if (this.props.calcInitData && this.props.calcInitData > 0) {      
    //   this.setState({
    //     formula: this.props.calcInitData
    //   });
    // }
  }
  ...
  updateFormula = input => {
    ...
    if (this.props.numberDigits != null && this.props.numberDigits != undefined && this.props.numberDigits != 0) {
      // if (input.length > this.props.numberDigits) return;
