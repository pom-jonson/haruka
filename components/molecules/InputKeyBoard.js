...
class InputKeyBoard extends Component {
    ...
    selectSearchType = (e) => {
        this.props.selectSearchType(parseInt(e.target.value));
    };
                                ...
                                <>
                                    {search_type.map((item, index)=>{
                                        return (
                                            <>
                                                <RadioButton
                                                    id={`search_type_${index}`}
                                                    value={index}
                                                    label={item}
                                                    name="search_type"
                                                    getUsage={this.selectSearchType.bind(this)}
                                                    checked={this.props.search_type === index ? true : false}
                                                />
                                            </>
                                        );
                                    })
...
InputKeyBoard.contextType = Context;

InputKeyBoard.propTypes = {
    search_type:PropTypes.number,
