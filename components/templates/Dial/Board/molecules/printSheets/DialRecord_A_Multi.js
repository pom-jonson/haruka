...
import {removeLeadZeros, makeList_code} from "~/helpers/dialConstants";
...
class DialRecord_A_Multi extends Component {
    constructor(props) {
        super(props);
        ...
        var all_dial_methods = sessApi.getObjectValue('dial_common_master',"dial_method_master");
        this.dial_method_master = makeList_code(all_dial_methods);
        ...
        this.td_count = [];
        for(var i = 0; i < this.graph_axis.x_range_long; i++) {
    ...
    render() {
        ...
        let {treat_monitor_list, staff_list_by_number, doctor_list_by_number, instruction_list, disease_history} = this.props;
        
        this.setGraphListData(this.props.rows_blood, this.props.rows_measure, this.props.rows_temp);

        let actualDrainage = '';
        
        if(schedule_data !== undefined && schedule_data.dial_pattern !== undefined && schedule_data.dial_pattern !== null){
        ...
        let plan_hours = schedule_data!=undefined && schedule_data.dial_pattern != undefined && schedule_data.dial_pattern != null?schedule_data.dial_pattern.reservation_time:'';
        ...
        if (this.min_x != '') {
            ...
            this.makeTimeListMeasure(start_time, this.graph_axis.x_range_long);
        }
        ...
        return (
            <List>
                <Header>
                    <div style={{fontSize:"46px", textDecoration:'underline'}} className={`text-center w100`}>【血液透析記録】</div>
                </Header>
                <Header>
                    ...
                    <div className={`flex`}>
                        <div className={`w100 `}>
                            ...
                            <tr>
                                ...
                                <td className="text-center" style={{borderTopColor:'black'}}>{schedule_data !== undefined && schedule_data!=null && schedule_data.dial_pattern !== null && this.dial_method_master[schedule_data.dial_pattern.dial_method] !== undefined ?
                                  this.dial_method_master[schedule_data.dial_pattern.dial_method] : ""}</td>
                                <th className="w90p" style={{borderLeftColor:'black', borderTopColor:'black'}}>開始時間</th>
                                <td className="w10 text-center" style={{borderTopColor:'black'}}>{schedule_start_time}</td>
                            ...
                            <tr>
                                ...
                                <td className="w10 text-center">{schedule_end_time}</td>
                            ...
                            <tr>
                                ...
                                <td className="text-center">{this.props.showImage!=undefined && this.props.showImage !=null && this.props.showImage.va_name}</td>
                    ...
                    <div className={`w100 print-area-b`}>
                        ...
                        <div className="mt-4" style={{fontSize:'1rem',width:'4rem', paddingTop:'1rem', marginRight:'0.5rem'}}>
                                ...
                                <div className="text-center ml-3" style={{marginTop:'3rem'}}>
                                    <div>脈拍</div>
                                    <div className="" style={{paddingTop:'0.2rem'}}>●</div>
                                </div>                                
                            </div>
                            <DialChart
                                showData={this.graph_data}
                        ...
                        <div className={`w100`}>
                            ...
                            {/* {graph_table_show.ms_target_drainage == "ON" && ( */}
                                <tr className={`inline-flex grey-back`}>
                                    <td className={`td-title`}>除水量設定</td>
                              ...
                              {/* {graph_table_show.ms_cur_drainage == "ON" && ( */}
                                <tr className={`inline-flex grey-back`}>
                                    <td className={`td-title`}>除水量積算</td>
                                    <td className={`unit`}>L</td>
                                    {this.display_measure_data.length > 0 && 
                                        Object.keys(this.time_series).map(key =>{
                                            if (this.display_measure_data[key] != undefined) {
                              ...
                              {/* {graph_table_show.ms_blood_target_flow == "ON" && (
                                <tr className={`inline-flex grey-back`}>
                                    <td className={`td-title`}>血流量設定</td>
                              ...
                              {/* {graph_table_show.ms_syringe_speed == "ON" && (
                                <tr className={`moreshow-area inline-flex`}>
                                    <td className={`td-title`}>シリンジポンプ速度設定</td>
                              ...
                              {/* {graph_table_show.ms_dialysate_target_temperature == "ON" && (
                                <tr className={`moreshow-area inline-flex`}>
                                    <td className={`td-title`}>透析液温度設定</td>
                              ...
                              {/* {graph_table_show.ms_dialysate_target_concentration == "ON" && (
                                <tr className={`moreshow-area inline-flex grey-back`}>
                                    <td className={`td-title`}>透析液濃度設定</td>
                              ...
                              {/* {graph_table_show.ms_dialysate_cur_concentration == "ON" && (
                                <tr className={`moreshow-area inline-flex grey-back`}>
                                    <td className={`td-title`}>透析液濃度</td>
                                    <td className={`unit`}>mS/cm</td>
                                    {this.display_measure_data.length > 0 && 
                                        Object.keys(this.time_series).map(key =>{
                                            if (this.display_measure_data[key] != undefined) {
                              ...
                              {/* {graph_table_show.ms_dializer_pressure == "ON" && (
                                <tr className={`moreshow-area inline-flex grey-back`}>
                                    <td className={`td-title`}>ダイアライザ血液入口圧</td>
                                    <td className={`unit`}>mmHg</td>
                                    {this.display_measure_data.length > 0 && 
                                        Object.keys(this.time_series).map(key =>{
                                            if (this.display_measure_data[key] != undefined) {
                              ...
                              {/* {graph_table_show.ms_fluid_target_amount == "ON" && (
                                <tr className={`moreshow-area inline-flex grey-back`}>
                                    <td className={`td-title`}>目標補液量</td>
                                    <td className={`unit`}>L</td>
                                    {this.display_measure_data.length > 0 && 
                                        Object.keys(this.time_series).map(key =>{
                                            if (this.display_measure_data[key] != undefined) {
                              ...
                              {/* {graph_table_show.ms_fluid_cur_amount == "ON" && ( */}
                                <tr className={`moreshow-area inline-flex grey-back`}>
                                    <td className={`td-title`}>補液量積算</td>
                                    <td className={`unit`}>L</td>
                                    {this.display_measure_data.length > 0 && 
                                        Object.keys(this.time_series).map(key =>{
                                            if (this.display_measure_data[key] != undefined) {
                              ...
                              {/* {graph_table_show.ms_fluid_target_temperature == "ON" && (
                                <tr className={`moreshow-area inline-flex grey-back`}>
                                    <td className={`td-title`}>補液温度設定</td>
                                    <td className={`unit`}>℃</td>
                                    {this.display_measure_data.length > 0 && 
                                        Object.keys(this.time_series).map(key =>{
                                            if (this.display_measure_data[key] != undefined) {
                              ...
                              {/* {graph_table_show.ms_hdf_amount == "ON" && ( */}
                                <tr className={`moreshow-area inline-flex grey-back`}>
                                    <td className={`td-title`}>総補液積算</td>
                                    <td className={`unit`}>L</td>
                                    {this.display_measure_data.length > 0 && 
                                        Object.keys(this.time_series).map(key =>{
                                            if (this.display_measure_data[key] != undefined) {
                              ...
                              {/* {graph_table_show.ms_emergency_amount == "ON" && (
                                <tr className={`moreshow-area inline-flex grey-back`}>
                                    <td className={`td-title`}>緊急総補液量</td>
                                    <td className={`unit`}>mL</td>
                                    {this.display_measure_data.length > 0 && 
                                        Object.keys(this.time_series).map(key =>{
                                            if (this.display_measure_data[key] != undefined) {
                        ...
                        <table className="table-scroll table table-bordered border-thick-table">
                            <tr>
                                <th style={{width:"50%"}}>現  症</th>
                                <th style={{width:"50%"}}>Dr指示</th>
                            </tr>
                            <tr>
                                <td style={{borderLeftColor:'black'}}>&nbsp;
                        ...
                        <table className="table-scroll table table-bordered border-thick-table">
                            <tr>
                                <th className={`text-center`} style={{width:'2.5rem'}}>時間</th>
                                <th className={`text-center w40`}>経過</th>
                                <th className={`text-center w30`}>処置</th>
                                <th className={`text-center`} style={{width:'10rem'}}>入力者</th>
                            </tr>
                                    ...
                                    if (Array.isArray(item)){
                                            ...
                                            return(
                                                <>
                                                    <tr onContextMenu={e => this.handleClick(e, item)}>
                                                        <td style={{borderLeftColor:'black'}} className="text-center">{item[0].value.write_date_time}</td>
                                                        {item.map((sub_item, sub_index) => {
                                                            if (this.checkSO(sub_item.value.category_2)) soap_left_body += '(' + sub_item.value.category_2 + ')' + sub_item.value.body +'<br/>'; 
                                                            if (!this.checkSO(sub_item.value.category_2)) soap_right_body += '(' + sub_item.value.category_2 + ')' + sub_item.value.body +'<br/>';
                                                            
                                                            if (sub_index == item.length-1){
                                                                return(
                                                                <>
                                                                    <td className="">{renderHTML(soap_left_body)}</td>
                                                                    <td className="">{renderHTML(soap_right_body)}</td>
                                                                </>
                                                                )                                                                
                                                            }
                                                        })}
                                                        {/* <td>{(item[0].value.instruction_doctor_number != null) ? doctor_list_by_number[item[0].value.instruction_doctor_number]: ""}</td> */}
                                                        <td style={{borderRightColor:'black'}} className='text-center'>{item[0].value.updated_by !== null?staff_list_by_number[item[0].value.updated_by]: ""}</td>
                                                    </tr>
                                                </>
                                            )
                                        }
                                        ...
                                        if (item.value.category_1!='Drカルテ'){
                                            return (
                                                <>
                                                    <tr onContextMenu={e => this.handleClick(e, item)}>
                                                        <td style={{borderLeftColor:'black'}} className="text-center">{item.value.write_date_time}</td>
                                                        ...
                                                        <td className='text-center' style={{borderRightColor:'black'}}>{item.value.updated_by !== null?staff_list_by_number[item.value.updated_by]: ""}</td>
                                                    </tr>
                                                </>
                                            )
                                        }
...
DialRecord_A_Multi.contextType = Context;

DialRecord_A_Multi.propTypes = {
    ...
    treat_monitor_list : PropTypes.array,    
    showImage : PropTypes.object,
    instruction_list:PropTypes.array,
    staff_list_by_number:PropTypes.object,
    doctor_list_by_number:PropTypes.object,    
};

export default DialRecord_A_Multi;