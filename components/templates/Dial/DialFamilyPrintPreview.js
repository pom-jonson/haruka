...
class DialFamilyPrintPreview extends Component {
  constructor(props) {
    super(props);
    this.state = {
      numPages: null,
  ...
  async componentDidMount() {
    // download pdf
    var url = "/app/api/v2/dial/generatepdf/family_print";
    ...
    axios({
      ...
      data: {
        ...
        top_pairs : this.props.top_pairs,
        bottom_pairs:this.props.bottom_pairs,
        top_bottom_pairs:this.props.top_bottom_pairs
      },
  ...
  get_title_pdf = async () => {
    ...
    let pdf_file_name = "家族歴_" + this.props.patient_info.patient_number + "_" + server_time + ".pdf";
...
DialFamilyPrintPreview.contextType = Context;

DialFamilyPrintPreview.propTypes = {
  closeModal: PropTypes.func,
  content_data : PropTypes.object,
  patient_info : PropTypes.object,
  top_pairs : PropTypes.array,
  bottom_pairs : PropTypes.array,
  top_bottom_pairs : PropTypes.array,
};

export default DialFamilyPrintPreview;
