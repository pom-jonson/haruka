...
const Wrapper = styled.div`
 ...
 `;
class DialSelectDialyzerMasterModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    this.getDialyzerData();
  }
  
  getDialyzerData = async() => {
    await axios.post(
      ...
      this.setState({
        dialyzerList:res.data,
        MasterCodeData:res.data,
        dialyzerCodeData: makeList_code(res.data),
        is_loaded: true
      });
    })
  }
...
DialSelectDialyzerMasterModal.contextType = Context;

DialSelectDialyzerMasterModal.propTypes = {
...
export default DialSelectDialyzerMasterModal;