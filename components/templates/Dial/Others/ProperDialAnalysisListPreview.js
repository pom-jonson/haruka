...
class ProperDialAnalysisListPreview extends Component {
  constructor(props) {
    super(props);
    this.state = {
      numPages: null,
  ...
  async componentDidMount() {
    let path = '/app/api/v2/dial/generatepdf/proper_dial_analysis_list';
    let print_data = {};
  ...
  get_title_pdf = () => {
    ...
    let pdf_file_name = "適正透析分析" + "_" + server_time + ".pdf";
...
ProperDialAnalysisListPreview.contextType = Context;

ProperDialAnalysisListPreview.propTypes = {
...
export default ProperDialAnalysisListPreview;