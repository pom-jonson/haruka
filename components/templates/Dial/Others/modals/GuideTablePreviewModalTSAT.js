...
class GuideTablePreviewModalTSAT extends Component {
  constructor(props) {
    super(props);
    this.state = {
      numPages: null,
  ...
  async componentDidMount() {
    let path = '/app/api/v2/dial/generatepdf/ferritin_tsat';
    let print_data = {};
  ...
  get_title_pdf = () => {
    ...
    let pdf_file_name = "フェリチンとTSATの治療指針(一覧)" + "_" + server_time + ".pdf";
  ...
  render() {
    ...
    return (
      ...
      >
        <Modal.Header>
          <Modal.Title>フェリチンとTSATの治療指針(一覧)</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Wrapper>
...
GuideTablePreviewModalTSAT.contextType = Context;

GuideTablePreviewModalTSAT.propTypes = {
...
export default GuideTablePreviewModalTSAT;
