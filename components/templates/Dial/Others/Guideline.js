...
import GuidelineCriteriaModal from "./modals/GuidelineCriteriaModal"
import GraphPreviewModal from "./modals/GraphPreviewModal"
import GuideTablePreviewModal from "./modals/GuideTablePreviewModal"
...
class Guideline extends Component {
  ...
  getCriteriaData = async () => {
    ...
    await apiClient.post(path, {params:{'kind':'P&Ca'}}).then(res => {
      this.setState({
        comment:res.comment,
        note:res.note,
        P_low:res.P_low,
  ...
  getExamData = async() => {
    let path = "/app/api/v2/dial/medicine_information/examination_data/getByCode";
    let post_data = {
  ...
  render() {
    ...
    return (
      <>
        ...
        <Card>
          <div className='flex'>
            <div className="title">PとCaの治療指針</div>
            <div className='others'>
              <Button className="disable-button">PとCaの治療指針</Button>
              ...
              <Graph>
                <div className="flex width100">
                  <div className="c_graph">
                    <div className="ver-point">補Ca</div>
                    <div className="triangle-up"></div>
                    <div className="ver-line height-line-1"></div>
                    <div className="ver-point">{this.state.Ca_high}</div>
                    <div className="ver-line height-line-2"></div>
                    <div className="ver-point">{this.state.Ca_low}</div>
                ...
                <div className="flex p_graph">
                  ...
                  <div className="her-point">{this.state.P_low}</div>
                  <div className="hor-line width-line-2"></div>
                  <div className="her-point">{this.state.P_high}</div>
                  <div className="hor-line width-line-3"></div>
                  <div className="triangle-right"></div>
                  <div className="her-point">P</div>
                </div>
              </Graph>
          ...
          {this.state.isGraphPreviewModal && (
            <GraphPreviewModal
              ...
              horr_low = {this.state.P_low}
              horr_high = {this.state.P_high}
              ver_low = {this.state.Ca_low}
              ver_high = {this.state.Ca_high}
              section = {this.state.section}
              start_date = {this.state.start_date}
              end_date = {this.state.end_date}
              horr_name = 'P'
              ver_name = '補Ca'
              modal_title = "PとCaの治療指針(9分割)"
            />
          )}
        </Card>
      </>
