...
class DiseaseHistoryPrintPreviewModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      numPages: null,
  ...
  async componentDidMount() {
    // download pdf
    var url = "/app/api/v2/dial/generatepdf/disease_history";
    ...
    axios({
      ...
      data: {
        ...
        past_history: this.props.past_history,
        disease_history: this.props.disease_history,
        write_date: this.props.write_date,
        disease_codes: this.props.disease_codes,
        disease_list: this.props.disease_list,
      },
  ...
  get_title_pdf = () => {
    let pdf_file_name = "病歴_" + this.props.patientInfo.patient_number + "_" + this.props.write_date.split("-").join("") + ".pdf";
...
DiseaseHistoryPrintPreviewModal.contextType = Context;

DiseaseHistoryPrintPreviewModal.propTypes = {
  closeModal: PropTypes.func,
  patientInfo: PropTypes.object,
  doctor_name: PropTypes.string,
  past_history: PropTypes.string,
  disease_history: PropTypes.string,
  write_date: PropTypes.string,
  disease_codes: PropTypes.array,
  disease_list: PropTypes.object,
};

export default DiseaseHistoryPrintPreviewModal;
