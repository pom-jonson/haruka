...
// import backgroundUrl from "~/components/_demo/Help/background.jpg";
...
class CalculateMinusClothes extends Component {
    constructor(props) {
        super(props);
        this.state = {
                ...
                <div className="card-body">
                    <Wrapper>
                        ...
                        <div className="flex">
                            <div className="box-detail">
                                <div className="tl w50 padding">風袋②</div>
                                <div className="tr w50 padding bc-red">--.-㎏</div>
                            </div>
                            <div className="box-detail">
                        ...
                        <div className="flex">
                            <div className="box-detail">
                                ...
                                <div className="tr w50 padding">2.5㎏</div>
                            </div>
                            <div className="box-detail">
...
export default CalculateMinusClothes