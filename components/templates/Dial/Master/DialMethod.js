...
class DialMethod extends Component {
    constructor(props) {
        super(props);
        this.state = {
                            ...
                            return (
                                <>
                                    <tr onContextMenu={e => this.handleClick(e, index)}>
                                        ...
                                        <td className='name'>{item.dialysis_method_category}</td>
                                        <td className='text-right'>{item.mode_number}</td>
                                    </tr>
                                </>)
                        })
                    )}
...
DialMethod.contextType = Context;

DialMethod.propTypes = {
    table_data: PropTypes.array,
    editData: PropTypes.func,
    deleteData: PropTypes.func,
    delete:PropTypes.func,
};
export default DialMethod