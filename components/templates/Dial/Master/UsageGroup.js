...
import UsageGroupModal from "../modals/UsageGroupModal";
        ...
        return (
            <ContextMenuUl>
                <ul className="context-menu" style={{ left: `${x}px`, top: `${y}px` }}>
                    {$canDoAction(FEATURES.DIAL_USAGE_GROUP_MASTER,AUTHS.EDIT,0) != false && (
                        <li><div onClick={() => parent.contextMenuAction(favouriteMenuType,"edit")}>編集</div></li>
                    )}
                    {$canDoAction(FEATURES.DIAL_USAGE_GROUP_MASTER,AUTHS.DELETE,0) != false && (
...
class UsageGroup extends Component {
    constructor(props) {
        super(props);
        let table_data = [];
        this.state = {
    ...
    createCode = () => {
        if (this.context.$canDoAction(this.context.FEATURES.DIAL_USAGE_GROUP_MASTER,this.context.AUTHS.REGISTER, 0) === false) {
    ...
    render() {
        ...
        return (
            <Card>
                <div className='flex'>
                    <div className="title">服用グループマスタ</div>
                    <div className='others'>
                        <Button onClick={this.goOtherPage.bind(this,"/dial/master/usage")}>服用マスタ</Button>
                        <Button className="disable-button">服用グループマスタ</Button>
                    </div>
                </div>
                <SearchPart>
                                      ...
                                      return (
                                          <>
                                              <tr onContextMenu={e => this.handleClick(e, index)}>
                                                  ...
                                                  <td className="">{item.name_kana}</td>
                                              </tr>
                                          </>)
                                  })
                              )}
...
UsageGroup.contextType = Context;
