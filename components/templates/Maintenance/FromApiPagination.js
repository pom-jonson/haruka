...
class FromApiPagination extends React.Component {
  constructor(props) {
      super(props);
      this.state = { pager: {} };
  }
  ...
  render() {
      var pager = this.state.pager;      
      if ((!pager.pages || pager.pages.length <= 1) && this.props.showAlways != true) {
...
FromApiPagination.defaultProps = defaultProps;

export default FromApiPagination;
