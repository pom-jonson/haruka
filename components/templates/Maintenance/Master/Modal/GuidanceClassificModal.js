...
class GuidanceClassificModal extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            sending_category: modal_data !== null ? modal_data.sending_category : 1,
            medical_business_diagnosing_type: modal_data !== null ? modal_data.medical_business_diagnosing_type : '',
            id,
            title,
    ...
    setMedicalBusinessDiagnosingType = e => {
    ...
    async registerMaster()  {
        ...
        switch(this.props.kind){
            case 0:
                path = "/app/api/v2/master/guidance/registerClassific";
                break;
            case 1:
                path = "/app/api/v2/master/guidance/registerClassificDetail";
                break;            
        }
                    ...
                    <Wrapper>
                        ...
                        {this.props.kind == 1 && (
                            <>
                                ...
                                <SelectorWithLabel
                                    options={this.state.sending_categories}
                                    title="送信制御区分"
                                    getSelect={this.setSendingCategory}
                                ...
                                <NumericInputWithUnitLabel
                                    ...
                                    getInputText={this.setMedicalBusinessDiagnosingType.bind(this)}
                                    inputmode="numeric"
                                />
                            </>
                        )}
...
GuidanceClassificModal.contextType = Context;

GuidanceClassificModal.propTypes = {
...
export default GuidanceClassificModal;
