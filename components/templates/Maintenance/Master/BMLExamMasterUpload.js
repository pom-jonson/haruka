...
class BMLExamMasterUpload extends React.Component {
    ...
    onFormSubmit(e){
        ...
        axios.post("/app/api/v2/karte/bml_exam_master/upload", formData, config)
        .then((response) => {
    ...
    render() {
        return (
            ...
            <Wrapper>
                ...
                <Title>BML検査項目マスタ取り込み</Title>
                <FormUpload>
                <form onSubmit={this.onFormSubmit}>
                    <label>BML検査項目マスタファイル</label>
...
export default BMLExamMasterUpload