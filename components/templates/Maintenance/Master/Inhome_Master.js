...
import InhomeClassificModal from "./Modal/InhomeClassificModal";
...
class Inhome_Master extends Component {
    constructor(props) {
        super(props);       
        this.state = {
            list_array:[],
    ...
    getFirstLayer = async() => {
        let path = '';        
        path = "/app/api/v2/master/inhome/searchClassific";
    ...
    getSecondLayer = async() => {
        let path = '';
        let post_data;        
        path = "/app/api/v2/master/inhome/searchClassificDetail";
    ...
    getThirdLayer = async() => {
        var path = "/app/api/v2/master/inhome/searchAddition";
        var post_data = {
    ...
    addAddition = async(item) => {        
        let path = "/app/api/v2/master/inhome/registerClassficAdd";
        let post_data = {
            params:{
                classific_detail_id:this.state.selected_classific_detail_id,
    ...
    editData = (index, kind) => {
      ...
      deleteData = async () => {
        ...
        switch(this.state.kind){
            case 0:
                path = "/app/api/v2/master/inhome/deleteClassific";
                ...
                break;
            case 1:                    
                path = "/app/api/v2/master/inhome/deleteClassificDetail";
                await apiClient.post(path,  post_data);
                ...
                break;
            case 2:
                path = "/app/api/v2/master/inhome/deleteClassificAdd";
                await apiClient.post(path,  post_data);
                this.getThirdLayer();
                break;
        }        
            ...
            <Card>
                ...
                <List>
                    <table className="table-scroll table table-bordered" id="wordList-table">
                        ...
                        <tr>
                            <th className='td-no'/>
                            <th style={{width:'100px'}}>在宅分類ID</th>
                            <th className="name">在宅分類名</th>
                        </tr>
                        </thead>
                        <tbody>
                ...
                <List>
                    <table className="table-scroll table table-bordered" id="wordList-table">
                        ...
                        <tr>
                            ...
                            <th style={{width:'120px'}}>在宅分類詳細ID</th>
                            <th className="name">在宅分類詳細名</th>
                        </tr>
                        </thead>
                        <tbody>
