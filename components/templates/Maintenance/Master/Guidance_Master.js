...
import GuidanceClassificModal from "./Modal/GuidanceClassificModal";
...
class Guidance_Master extends Component {
    constructor(props) {
        super(props);       
        this.state = {
            list_array:[],
    ...
    addAddition = async(item) => {        
        let path = "/app/api/v2/master/guidance/registerClassficAdd";
        let post_data = {
            params:{
                classific_detail_id:this.state.selected_classific_detail_id,
    ...
    editData = (index, kind) => {
      ...
      deleteData = async () => {
        ...
        switch(this.state.kind){
            case 0:
                path = "/app/api/v2/master/guidance/deleteClassific";
                ...
                break;
            case 1:                    
                path = "/app/api/v2/master/guidance/deleteClassificDetail";
                await apiClient.post(path,  post_data);
                ...
                break;
            case 2:
                path = "/app/api/v2/master/guidance/deleteClassificAdd";
                await apiClient.post(path,  post_data);
                this.getThirdLayer();
                break;
        }        
                                    ...
                                    return(
                                        <>
                                            ...
                                            onClick={this.getDetails.bind(this, item.number, item.classific_id)} onContextMenu={e => this.handleClick(e,index, 0)}>
                                                ...
                                                <td style={{width:'80px'}}>{item.classific_id}</td>
...
export default Guidance_Master