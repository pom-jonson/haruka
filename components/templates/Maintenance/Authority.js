...
class Authority extends Component {
    ...
    getSearchResult = async () => {
        let path = "/app/api/v2/dial/authority/search";
        let post_data = {
    ...
    delete = () => {
        this.setState({
            ...
            confirm_message: "権限情報を削除してもいいてすか?",
        });
    }
    ...
    deleteData = async () => {
        let path = "/app/api/v2/dial/authority/delete";
        let post_data = {
