...
class RadiationListPrintModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  async componentDidMount() {
    // download pdf
    var url;
    url = '/app/api/v2/print_haruka/generatepdf/radiation_list_print';
    ...
    axios({
      ...
      data:{
        ...
        select_date_type:this.props.select_date_type,
        state:this.props.state,
        department:this.props.department,
        keyword:this.props.keyword,
        extract_radiation_id: this.props.extract_radiation_id,
      },
...
RadiationListPrintModal.contextType = Context;

RadiationListPrintModal.propTypes = {
  closeModal: PropTypes.func,
  print_data: PropTypes.array,
  search_date : PropTypes.string,
  start_date : PropTypes.string,
  select_date_type : PropTypes.bool,
  department : PropTypes.string,
  keyword : PropTypes.string,
  state : PropTypes.string,
  print_type : PropTypes.string,
  extract_radiation_id : PropTypes.number,
};

export default RadiationListPrintModal;
