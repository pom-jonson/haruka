...
class HospitalMoveDetail extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return  (
      <Modal show={true}  className="custom-modal-sm first-view-modal haruka-done-modal">
        <Modal.Header><Modal.Title>転棟・転室</Modal.Title></Modal.Header>
        <Modal.Body>
          <Wrapper>
                    ...
                    <div className={`data-title ${this.getOrderTitleClassName(1, modal_data.karte_status)}`}>
                      <div className={'data-item'}>
                        <div className="flex justify-content">
                          <div className="note">【入院・転棟・転室実施】</div>
                    ...
                    <MedicineListWrapper>
                      <div className="history-item">
                        <div className="phy-box w70p">
                          ...
                          {modal_data.order_data.order_data.department_name !== undefined && (
                            <div className="flex between drug-item table-row">
                              <div className="text-left">
...
HospitalMoveDetail.contextType = Context;
HospitalMoveDetail.propTypes = {
  closeModal: PropTypes.func,
  modal_data: PropTypes.object,
};
export default HospitalMoveDetail;
