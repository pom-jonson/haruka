...
export class HospitalMoveHistoryModal extends Component {
  constructor(props) {
    super(props);
                            ...
                            <div className={`history-item ${output.is_enabled == 2 ? "deleted-order" : ""}`}>
                              <div className="phy-box w70p">
                                ...
                                <div className="flex between drug-item table-row">
                                  ...
                                  <div className="text-left right-value">{output.order_data.order_data.ward_name}</div>
                                </div>
                                <div className="flex between drug-item table-row">
                                  <div className="text-left">
                                    <div className="table-item">病室</div>
                                  </div>
                                  <div className="text-left right-value">{output.order_data.order_data.room_name}</div>
                                </div>
                                <div className="flex between drug-item table-row">
                                  <div className="text-left">
                                    <div className="table-item">ベッド</div>
                                  </div>
                                  <div className="text-left right-value">{output.order_data.order_data.bed_name}</div>
                                </div>
                              </div>
                            </div>
                          </div>
...
HospitalMoveHistoryModal.contextType = Context;

HospitalMoveHistoryModal.propTypes = {
  closeModal: PropTypes.func,
  getDepartmentName: PropTypes.func,
  historySoapList: PropTypes.array,
};

export default HospitalMoveHistoryModal;