...
class HospitalOutInDetail extends Component {
  constructor(props) {
    super(props);
                          ...
                          {modal_data.sub_category === '外泊実施' && (
                            <>
                              <div className="flex between drug-item table-row">
                                ...
                                <div className="text-right">
                                  <div className="table-item remarks-comment">{modal_data.order_data.order_data.going_out_name}</div>
                                </div>
                              </div>
                              <div className="flex between drug-item table-row">
                                <div className="text-left">
                                ...
                                <div className="text-right">
                                  <div className="table-item remarks-comment">
                                    {formatJapanDateSlash(modal_data.order_data.order_data.stop_serving_date)
                                    +" （"+modal_data.order_data.order_data.stop_serving_time_name+"）"}より停止
                                  </div>
                                </div>
                              </div>
                            </>
...
HospitalOutInDetail.contextType = Context;
HospitalOutInDetail.propTypes = {
  closeModal: PropTypes.func,
  modal_data: PropTypes.object,
};
export default HospitalOutInDetail;
