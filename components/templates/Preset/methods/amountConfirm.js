...
export default async function(
  ...
  if (changeNumber.indexPres != -1) {
    ...
    if (this.state.indexOfInsertPres != -1) {
      ...
      pres.medicines[index].can_generic_name = this.state.bulk.can_generic_name;
      pres.medicines[index].is_not_generic = this.state.bulk.is_not_generic;
      pres.medicines[index].milling = this.state.bulk.milling;
      medRpIdx = this.state.indexOfInsertPres;
      medRpOrderIdx = index;
    } else if (this.state.indexOfEditPres != -1) {

      pres = originalNumber[this.state.indexOfEditPres];
