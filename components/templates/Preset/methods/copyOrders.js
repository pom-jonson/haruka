...
export default async function(prescription) {
  ...
  prescription.order_data.order_data.forEach((order, index) => {
    ...
    newMedicines = newMedicines.map(medicine => {
      ...
      medicine.can_generic_name = medicine.can_generic_name === undefined ? this.state.bulk.can_generic_name : medicine.can_generic_name;
      // this.state.bulk.can_generic_name === 1
      //   ? this.state.bulk.can_generic_name
      //   : medicine.can_generic_name;

      medicine.is_not_generic = medicine.is_not_generic === undefined ? this.state.bulk.is_not_generic : medicine.is_not_generic;
      // this.state.bulk.is_not_generic === 1
      //   ? this.state.bulk.is_not_generic
      //   : medicine.is_not_generic;
      medicine.milling = medicine.milling === undefined ? this.state.bulk.milling : medicine.milling;
      // this.state.bulk.milling === 1
      //   ? this.state.bulk.milling
      //   : medicine.milling;
    ...
    originalNumber.splice(idx + index, 0, {
      ...
      temporary_medication: order.temporary_medication === undefined ? this.state.bulk.temporary_medication : order.temporary_medication,
      // this.state.bulk.temporary_medication === 1
      //   ? this.state.bulk.temporary_medication
      //   : order.temporary_medication,
      one_dose_package: order.one_dose_package === undefined ? this.state.bulk.one_dose_package : order.one_dose_package,
      mixture: order.mixture === undefined ? 0 : order.mixture,
      // this.state.bulk.one_dose_package === 1
      //   ? this.state.bulk.one_dose_package
