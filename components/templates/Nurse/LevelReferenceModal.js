...
//   import * as colors from "~/components/_nano/colors";
  ...
  `;
  class LevelReferenceModal extends Component {
    constructor(props) {
      super(props);
      this.state = {
        confirm_flag:false,
    ...
    getSearchResult = async() => {
      ...
      let post_data = {patient_id:this.props.selected_item.system_patient_id};
      ...
      return (
        <>
          <Modal show={true} id="outpatient" className="custom-modal-smfirst-view-modal">
            <Modal.Header>
              <Modal.Title style={{width:'25rem'}}>レベル歴参照</Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <Popup>
                      ...
                      this.state.history_data.map(item => {
                        ...
                        return (
                          ...
                          <tr>
                            ...
                            <td>
                              {Object.keys(necessary_master).map(key => {
                                if (item[necessary_master[key]] > 0){
                                  return(
                                    <>
                                    <div>{key}</div>
                                    </>
  ...
  LevelReferenceModal.contextType = Context;
  
  LevelReferenceModal.propTypes = {
    closeModal: PropTypes.func,
    selected_item: PropTypes.object,
    necessary_master: PropTypes.object,
  };
  
  export default LevelReferenceModal;
