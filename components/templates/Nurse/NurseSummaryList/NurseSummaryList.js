...
class NurseSummaryList extends Component {
  constructor(props) {
    super(props);
    let patient_number = "";
    let re = /patients[/]\d+/;
  ...
  getSummaryList = async()=> {
    ...
    let path = "/app/api/v2/nursing_service/get/summary_list";
    let post_data = {
    ...
    if (e.type === "contextmenu") {
      ...
      this.setState({
        contextMenu: {
          ...
          can_register_flag:this.context.$canDoAction(this.context.FEATURES.HOSPITAL_NURSE_SUMMARY,this.context.AUTHS.REGISTER),
          can_edit_flag:this.context.$canDoAction(this.context.FEATURES.HOSPITAL_NURSE_SUMMARY,this.context.AUTHS.EDIT),
          can_delete_flag:this.context.$canDoAction(this.context.FEATURES.HOSPITAL_NURSE_SUMMARY,this.context.AUTHS.DELETE),
        }
      })
    }
  };
  ...
  download_pdf=async()=> {
    ...
    let path = "/app/api/v2/nursing_service/nurse_summary/list/print";
    ...
    print_data.approval_categorys = this.state.approval_categorys;
  ...
  download_csv=async()=> {
    ...
    this.state.pageOfItems.map((summary, index)=>{
      ...
      data_item.push((summary.summary_data == null || summary.summary_data.create_flag == 0) ? "" : (summary.summary_data.approval_category == 0)
  ...
  render() {
    return (
      <>
        ...
        >
          <Modal.Header><Modal.Title>看護サマリー一覧</Modal.Title></Modal.Header>
          <Modal.Body>
              ...
              <Wrapper>
                <div className='flex'>
                  <div className='patient-id-area flex'>
                    ...
                    />
                    <Button type="common" style={{marginLeft:'0.5rem'}} onClick={this.getSummaryList.bind(this)}>ID検索</Button>
                  </div>
                ...
                <div className='flex'>
                  ...
                  <div className='flex'>
                    <div className='button-area'>
                      ...
                      <Button style={{marginBottom:'3px'}} type="common" onClick={this.setCheckStatusAll.bind(this, 1)}>全選択</Button><br/>
                      <Button type="common" onClick={this.setCheckStatusAll.bind(this, 0)}>全解除</Button>
                    </div>
                  </div>
                ...
                <div className='flex btn-area'>
                  ...
                  <div className='right-btn flex'>
                    <Button type="common" className={'search-btn ' + (((this.state.pageOfItems == null) || (this.state.pageOfItems.length == 0) || (this.state.load_flag == false)) ? 'disable-btn' : '')} onClick={this.download_csv.bind(this)}>ファイル出力</Button>                    
                    <Button type="common" className={'search-btn'} onClick={this.clearSearchCondition.bind(this)}>条件クリア</Button>
                    <Button type="common" className={'search-btn'} onClick={this.openSaveSearchCondition}>条件保存</Button>
                  </div>
                </div>
                      ...
                      <>
                        {this.state.pageOfItems != null && this.state.pageOfItems.length > 0 && (
                          this.state.pageOfItems.map((summary, index)=>{
                            return (
                              <>
                                <tr onDoubleClick={this.openSummaryAgreeModal.bind(this, summary)} onContextMenu={e => this.handleClick(e, summary)}>
...
NurseSummaryList.contextType = Context;
NurseSummaryList.propTypes = {
  closeModal: PropTypes.func,
};

export default NurseSummaryList;
