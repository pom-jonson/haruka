...
class ChangeMealModal extends Component {
  constructor(props) {
    ...
    if(props.cache_index != null){
      init_data = karteApi.getSubVal(props.patientId, CACHE_LOCALNAMES.MEAL_EDIT, this.props.cache_index);
    } else {
      init_data = props.modalData;
    }    
    this.state={
      ...
      start_date:(init_data !== undefined && init_data != null && init_data.start_date != undefined) ? new Date(init_data.start_date) : new Date(),
      start_time_classification:(init_data !== undefined && init_data != null && init_data.start_time_classification != undefined) ? init_data.start_time_classification : 0,
      meal_time_classification_master:[{id:0, value:""}],
      meal_number_master:[{id:0, value:""}],
      number_of_meals: (init_data !== undefined && init_data != null && init_data.number_of_meals != undefined) ? init_data.number_of_meals : 0,
      food_type_id: (init_data !== undefined && init_data != null && init_data.food_type_id != undefined) ? init_data.food_type_id : 0,
      staple_food_master:[{id:0, value:""}],
      staple_food_id_morning:(init_data !== undefined && init_data != null && init_data.staple_food_id_morning != undefined) ? init_data.staple_food_id_morning : 0,
      staple_food_id_noon:(init_data !== undefined && init_data != null && init_data.staple_food_id_noon != undefined) ? init_data.staple_food_id_noon : 0,
      staple_food_id_evening:(init_data !== undefined && init_data != null && init_data.staple_food_id_evening != undefined) ? init_data.staple_food_id_evening : 0,
      drink_master:[{id:0, value:""}],
      drink_id_morning:(init_data !== undefined && init_data != null && init_data.drink_id_morning != undefined) ? init_data.drink_id_morning : 0,
      drink_id_noon:(init_data !== undefined && init_data != null && init_data.drink_id_noon != undefined) ? init_data.drink_id_noon : 0,
      drink_id_evening:(init_data !== undefined && init_data != null && init_data.drink_id_evening != undefined) ? init_data.drink_id_evening : 0,
      meal_disease_name_id:(init_data !== undefined && init_data != null && init_data.meal_disease_name_id != undefined) ? init_data.meal_disease_name_id : 0,
      meal_disease_name:(init_data !== undefined && init_data != null && init_data.meal_disease_name != undefined) ? init_data.meal_disease_name : '',
      isOpenSelectDiseaseModal:false,
      isAddDiseaseNameModal:false,
      confirm_message:"",
      confirm_type:"",
      serving_master:[{id:0, value:""}],
      serving_id:(init_data !== undefined && init_data != null && init_data.serving_id != undefined) ? init_data.serving_id : 0,
      meal_comment:[],
      meal_comment_numbers:(init_data !== undefined && init_data != null && init_data.meal_comment_numbers != undefined) ? init_data.meal_comment_numbers : [],
      free_comment:(init_data !== undefined && init_data != null && init_data.free_comment != undefined) ? init_data.free_comment : "",
      ...
      thick_liquid_food_id:(init_data !== undefined && init_data != null && init_data.thick_liquid_food_id != undefined) ? init_data.thick_liquid_food_id : 0,
      ingestion_method:[{id:0, value:""}],
      ingestion_method_id:(init_data !== undefined && init_data != null && init_data.ingestion_method_id != undefined) ? init_data.ingestion_method_id : 0,
      thick_liquid_food_morning:[{id:0, value:""}],
      thick_liquid_food_number_id_morning:(init_data !== undefined && init_data != null && init_data.thick_liquid_food_number_id_morning != undefined) ? init_data.thick_liquid_food_number_id_morning : 0,
      thick_liquid_food_noon:[{id:0, value:""}],
      thick_liquid_food_number_id_noon:(init_data !== undefined && init_data != null && init_data.thick_liquid_food_number_id_noon != undefined) ? init_data.thick_liquid_food_number_id_noon : 0,
      thick_liquid_food_evening:[{id:0, value:""}],
      thick_liquid_food_number_id_evening:(init_data !== undefined && init_data != null && init_data.thick_liquid_food_number_id_evening != undefined) ? init_data.thick_liquid_food_number_id_evening : 0,
      milk_id:(init_data !== undefined && init_data != null && init_data.milk_id != undefined) ? init_data.milk_id : 0,
      milk_amount:[{id:0, value:""}],
      milk_amount_id:(init_data !== undefined && init_data != null && init_data.milk_amount_id != undefined) ? init_data.milk_amount_id : 0,
      adjustment_amount:(init_data !== undefined && init_data != null && init_data.adjustment_amount != undefined) ? init_data.adjustment_amount : 0,
      milk_number_of_times_id_noon:(init_data !== undefined && init_data != null && init_data.milk_number_of_times_id_noon != undefined) ? init_data.milk_number_of_times_id_noon : 0,
      ...
      thick_liquid_food:[],
      milk_conditions_master:[],
      milk_master:[],
      milk_conditions_1:[{id:0, value:""}],
      milk_conditions_id1:0,
      milk_conditions_2:[],
      milk_conditions_id2:0,
      milks:[],
      is_loaded: false,
    };
    this.change_flag = 0;
  ...
  async componentDidMount() {
      ...
      .then((res) => {
        ...
        if(res.staple_food_master.length > 0){
          res.staple_food_master.map(item=>{
            staple_food_master.push({id:item.number, value:item.name, special_meal_code:item.special_meal_code});
          });
        }
    ...
    harukaValidate('karte', 'meal', 'meal_change', this.state, 'background');
  }
  ...
  thick_liquid_food_condition1=(e)=>{
    ...
    let thick_liquid_food_conditions2_ids = [];
    let thick_liquid_food = [];
    let thick_liquid_food_conditions_id1 = parseInt(e.target.id);
    if(this.state.thick_liquid_food_master.length > 0){
      this.state.thick_liquid_food_master.map(item=>{
        if(item.thick_liquid_food_conditions_id1 == thick_liquid_food_conditions_id1){
          thick_liquid_food_conditions2_ids.push(item.thick_liquid_food_conditions_id2);
          thick_liquid_food.push({id:item.number, value:item.name});
        }
      })
  ...
  milk_condition1=(e)=>{
    ...
    let milk_conditions2_ids = [];
    let milks = [];
    if(this.state.milk_master.length > 0){
      this.state.milk_master.map(item=>{
        if(item.milk_conditions_id1 == parseInt(e.target.id)){
          milk_conditions2_ids.push(item.milk_conditions_id2);
          milks.push({id:item.number, value:item.name});
        }
      })
    }
    if(milk_conditions2_ids.length > 0){
      this.state.milk_conditions_master.map(item=>{
        if(milk_conditions2_ids.includes(item.number)){
          milk_conditions_2.push({id:item.number, value:item.name});
        }
      })
    ...
    if(milks.length > 0) {
      milks.unshift({id:0,value:''});
    }
    this.setState({
      milk_conditions_id1:parseInt(e.target.id),
      milk_conditions_2,
      milks,
      milk_conditions_id2:0,
      milk_id:0,
  ...
  milk_condition2=(e)=>{
    ...
    if(this.state.milk_master.length > 0){
      this.state.milk_master.map(item=>{
        if(item.milk_conditions_id1 == this.state.milk_conditions_id1 && item.milk_conditions_id2 == parseInt(e.target.id)){
          milks.push({id:item.number, value:item.name});
        }
      })
    }
    milks.unshift({id:0,value:''});
    this.setState({
      milk_conditions_id2:parseInt(e.target.id),
      milks,
      milk_id:0,
    });
  }
  ...
  confirmSave=()=>{
    ...
    if (permission_meal) isDisableMealSelected = false;
    ...
    let canRegisterMeal = karteApi.checkMealPeriod(this.props.patientId, formatDateLine(this.state.start_date), null, cache_index);
    // checkMealPeriod(patient_id=null, _dateStart=null, _dateEnd=null, _cacheKey=null)
    if (!canRegisterMeal) {
      this.setState({notice_message: "同じ日付を含む食事指示とは同時に登録できません。"});
      return;
    }
  ...
  checkValidation = () => {
    let error_str_arr = [];
    let validate_data = harukaValidate('karte', 'meal', 'meal_change', this.state);
  ...
  saveCache=()=>{
    ...
    if(this.props.cache_index != null){
      karteApi.setSubVal(this.props.patientId, CACHE_LOCALNAMES.MEAL_EDIT, this.props.cache_index, JSON.stringify(meal_edit), 'insert');
    } else {
  ...
  render() {
    ...
    return (
      <>
        ...
        >
          <Modal.Header><Modal.Title>食事</Modal.Title></Modal.Header>
          <Modal.Body>
            <Wrapper>
            {this.state.is_loaded == false ? (
              ...
              <div className="left-col">
                <div className={'info-title'}>【食事情報】</div>
                <div className={'div-flex'} style={{marginBottom:"0.2rem"}}>
                  ...
                  <div className={'time-class'}>
                    <SelectorWithLabel
                      ...
                      disabledValue={permission_meal == true ? "" : changeMealStatus}
                    />
                  </div>
                  <div style={{marginLeft:"0.2rem", lineHeight:"2rem"}}>より開始</div>
                </div>
                <div className={'div-flex number-of-meals'}>
                  <SelectorWithLabel
                    id="number_of_meals_id"
                    title="食事回数"
                    options={this.state.meal_number_master}
                    getSelect={this.setNumberOfMeals}
                    departmentEditCode={this.state.number_of_meals}
                  />
                  <div className={'label-unit'}>回</div>
                </div>
                <div className="div-flex" style={{marginBottom:"0.2rem"}}>
                  <div className="label-title">前回食事復帰日時</div>
                  <div className="last-start-date"></div>
                  <div className="last-start-time-classification"></div>
                  <div style={{marginLeft: "0.2rem", lineHeight:"2rem"}}>より復帰</div>
                </div>
                <div className="select-food-condition div-flex">
                  <div className={'food-classific'} style={{marginBottom:"0.2rem"}}>
                    <SelectorWithLabel
                      title="食種"
                ...
                {/*<div className={'info-title'} style={{paddingTop:"0.3rem"}}>【ミルク食情報】</div>
                              <div className="thick-liquid-food">
                                <div className={'table-area'}>
                                  <table>
                                    <tr>
                                    ...
                                    <tr>
                                      <td><button className="clear-btn-2" onClick={this.confrimClear.bind(this, 'milk_conditions')}>C</button></td>
                                      <td>
                                        <div className="div-flex">
                                          <SelectorWithLabel
                                            title=""
                                            options={this.state.milk_conditions_1}
                                            getSelect={this.milk_condition1}
                                            departmentEditCode={this.state.milk_conditions_id1}
                                          />
                                          {this.state.milk_conditions_2.length > 0 && (
                                            <>
                                              <SelectorWithLabel
                                                title=""
                                                options={this.state.milk_conditions_2}
                                                getSelect={this.milk_condition2}
                                                departmentEditCode={this.state.milk_conditions_id2}
                                              />
                                            </>
                                          )}
                                ...
                                <div className={'table-area'}>
                                  <table>
                                    ...
                                    <tr>
                                      <td><button className="clear-btn-2" onClick={this.confrimClear.bind(this, 'milk')}>C</button></td>
                                      <td>
                                        <SelectorWithLabel
                                          title=""
              ...
              <div className="right-col">
                ...
                <div style={{width:"80%", marginBottom:"0.3rem"}}>
                ...
                <div className="div-flex" style={{marginBottom:"0.2rem", marginTop:"-1px"}}>
