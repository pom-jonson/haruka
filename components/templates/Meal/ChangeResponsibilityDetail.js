...
class ChangeResponsibilityDetail extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return  (
      <Modal show={true}  className="custom-modal-sm first-view-modal haruka-done-modal">
        <Modal.Header><Modal.Title>担当変更</Modal.Title></Modal.Header>
        <Modal.Body>
          <Wrapper>
                      ...
                      <div className="history-item">
                        <div className="phy-box w70p">
                          <div className="flex between drug-item table-row">
                            ...
                            <div className="text-right">
                              <div className="table-item remarks-comment">
                                {(modal_data.order_data.order_data.moving_day != undefined && modal_data.order_data.order_data.moving_day != "") ?
                                  formatJapanDateSlash(modal_data.order_data.order_data.moving_day)
                                  : ""}
                              </div>
                            </div>
                          </div>
                          <div className="flex between drug-item table-row">
                            ...
                            <div className="text-right">
                              <div className="table-item remarks-comment">
                                {(modal_data.order_data.order_data.prev_department_id !== undefined && modal_data.order_data.order_data.prev_department_id != modal_data.order_data.order_data.department_id)
                                  ? (modal_data.order_data.order_data.prev_department_name + " → ") : ""}{modal_data.order_data.order_data.department_name}
                              </div>
                            </div>
                          </div>
                          <div className="flex between drug-item table-row">
                            ...
                            <div className="text-right">
                              <div className="table-item remarks-comment">
                                {(modal_data.order_data.order_data.prev_main_doctor !== undefined && modal_data.order_data.order_data.prev_main_doctor != modal_data.order_data.order_data.mainDoctor)
                                  ? (modal_data.order_data.order_data.prev_main_doctor_name + " → ") : ""}{modal_data.order_data.order_data.mainDoctor_name}
                              </div>
                            </div>
                          </div>
                          {modal_data.order_data.order_data.doctors_name.length > 0 && (
                            <div className="flex between drug-item table-row">
                              <div className="text-left">
                              ...
                              <div className="text-right">
                                <div className="table-item remarks-comment">
                                  {modal_data.order_data.order_data.doctors_name.map(name=>{
                                    return (
                                      <>
                          ...
                          {modal_data.order_data.order_data.nurse_id_in_charge_name != "" && (
                            <div className="flex between drug-item table-row">
                              <div className="text-left">
                          ...
                          {modal_data.order_data.order_data.deputy_nurse_name != "" && (
                            <div className="flex between drug-item table-row">
                              <div className="text-left">
                          ...
                          {/* <div className="flex between drug-item table-row">
                                                                          ...
                                                                          <div className="text-right">
                                                                            <div className="table-item remarks-comment">
                                                                              {modal_data.order_data.order_data.team_name !== undefined ? modal_data.order_data.order_data.team_name : ""}</div>
                                                                          </div>
                                                                        </div> */}
                          {modal_data.order_data.order_data.comment != "" && (
                            <div className="flex between drug-item table-row">
                              <div className="text-left">
...
ChangeResponsibilityDetail.contextType = Context;
ChangeResponsibilityDetail.propTypes = {
  closeModal: PropTypes.func,
  modal_data: PropTypes.object,
};
export default ChangeResponsibilityDetail;
