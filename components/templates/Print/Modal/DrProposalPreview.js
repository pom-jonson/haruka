...
class DrProposalPreview extends Component {
  constructor(props) {
    super(props);
    this.state = {
      numPages: null,
  ...
  async componentDidMount() {
    let path = '/app/api/v2/dial/generatepdf/drpropsal';
    let print_data = {};
  ...
  get_title_pdf = async () => {     
    ...
    let pdf_file_name = "Dr上申" + "_" + server_time + ".pdf";
...
DrProposalPreview.contextType = Context;

DrProposalPreview.propTypes = {
...
export default DrProposalPreview;
