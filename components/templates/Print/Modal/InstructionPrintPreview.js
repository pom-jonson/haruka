...
class InstructionPrintPreview extends Component {
  constructor(props) {
    super(props);
    this.state = {
      numPages: null,
  ...
  async componentDidMount() {
    let path = '/app/api/v2/dial/generatepdf/instruction_print';
    let print_data = {};
    ...
    print_data.all_period = this.props.all_period;
    print_data.date_setting = this.props.date_setting;
    axios({
      url: path,
      method: "POST",
      data: { print_data },
  ...
  get_title_pdf = async () => {         
    ...
    let pdf_file_name = "指示一覧" + "_" + server_time + ".pdf";
...
InstructionPrintPreview.contextType = Context;

InstructionPrintPreview.propTypes = {
  closeModal: PropTypes.func,
  table_data: PropTypes.array,
  start_date: PropTypes.string,
  end_date: PropTypes.string,
  all_period: PropTypes.string,
  date_setting: PropTypes.string,
};

export default InstructionPrintPreview;
