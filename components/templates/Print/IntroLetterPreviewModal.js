...
class IntroLetterPreviewModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      numPages: null,
  ...
  async componentDidMount() {
    // download pdf
    var url;
    url = '/app/api/v2/dial/generatepdf/intro_print';
  ...
  get_title_pdf = () => {
    let pdf_file_name = "紹介状_" + this.props.patientInfo.patient_number + "_" + this.props.select_data.write_date.split("-").join("") + ".pdf";
...
IntroLetterPreviewModal.contextType = Context;

IntroLetterPreviewModal.propTypes = {
  closeModal: PropTypes.func,
  history_number: PropTypes.number,
  print_data: PropTypes.object,
  facility_name: PropTypes.string,
  patientInfo: PropTypes.object,
  other_facility_name_: PropTypes.string,
  other_facilities_doctor_name: PropTypes.string,
  greeting: PropTypes.string,
  diagnostic: PropTypes.string,
  note: PropTypes.string,
  facility_data: PropTypes.object,
  select_data: PropTypes.array,
  doctor_name: PropTypes.string,
};

export default IntroLetterPreviewModal;
