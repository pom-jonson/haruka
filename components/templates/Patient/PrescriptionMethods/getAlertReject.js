...
export default function(s_item, d_item) {
  ...
  let japic_alert_reject = conf_data.japic_alert_reject != undefined && conf_data.japic_alert_reject != null && conf_data.japic_alert_reject != "" ? conf_data.japic_alert_reject : 1;    
