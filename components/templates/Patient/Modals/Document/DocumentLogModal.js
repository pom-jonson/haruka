...
const Wrapper = styled.div`
  ...
  .history-content {
    ...
    .deleted-order .row{text-decoration: line-through;}
  }
...
export class DocumentLogModal extends Component {
  constructor(props) {
    super(props);
  ...
  downLoad=(path)=>{
    ...
    document.location.href = this.webdav_system_path+path;
    setTimeout(()=>{
                            ...
                            <div className="history-item">
                              <div className="phy-box w70p">
                                <div className="flex between drug-item table-row">
                                  ...
                                  <div className="text-left right-value">{output.order_data.order_data.slip_name}</div>
                                </div>
                                <div className="flex between drug-item table-row">
                                  <div className="text-left">
                                    <div className="table-item">文書タイトル</div>
                                  </div>
                                  <div className="text-left right-value">{output.order_data.order_data.name}</div>
                                </div>
                                <div className="flex between drug-item table-row">
                                  <div className="text-left">
                                  ...
                                  <div
                                   className="text-left right-value" style={{cursor:output.exist_flag == 1 ? "pointer" : ""}}
                                   onClick={this.downLoad.bind(this, output.exist_flag == 1 ? output.order_data.order_data.file_path : null)}
                                  >
                                    {output.order_data.order_data.file_path}
                                  </div>
                                </div>
...
DocumentLogModal.contextType = Context;

DocumentLogModal.propTypes = {
