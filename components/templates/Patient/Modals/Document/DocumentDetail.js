...
class DocumentDetail extends Component {
  ...
  render() {
    ...
    karte_status_name = modal_data.karte_status == 2 ? "訪問診療・" : (modal_data.karte_status == 3 ? "入院・" : karte_status_name);
    return  (
      <Modal show={true}  className="custom-modal-sm first-view-modal haruka-done-modal">
        <Modal.Header><Modal.Title>文書</Modal.Title></Modal.Header>
        <Modal.Body>
          <Wrapper>
                    ...
                    <div className={`data-title ${this.getOrderTitleClassName(1, modal_data.karte_status)}`}>
                      <div className={'data-item'}>
                        <div className="flex justify-content">
                          <div className="note">【{karte_status_name}文書】</div>
                      ...
                      <div className="phy-box w70p">
                        <div className="flex between drug-item table-row">
                          ...
                          <div className="text-right">
                            <div className="table-item remarks-comment">{modal_data.order_data.order_data.slip_name}</div>
                          </div>
                        </div>
                        <div className="flex between drug-item table-row">
                          <div className="text-left">
                          ...
                          <div className="text-right">
                            <div className="table-item remarks-comment">{modal_data.order_data.order_data.name}</div>
                          </div>
                        </div>
                        <div className="flex between drug-item table-row">
                          <div className="text-left">
                          ...
                          <div className="text-right">
                            <div className="table-item remarks-comment">{modal_data.order_data.order_data.file_path}</div>
                          </div>
                        </div>
...
DocumentDetail.contextType = Context;
