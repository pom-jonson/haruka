...
class WardLabelSlipModal extends Component {
    constructor(props) {
        super(props);        
        this.state = {
            result_list: [],
    ...
    render() {        
        return (
            <>
                ...
                >
                    <Modal.Header><Modal.Title>検体ラベル検査伝票一覧</Modal.Title></Modal.Header>
                    <Modal.Body>
                        <Wrapper>
                            <div className={'top-flex'}>
                                ...
                                <div style={{marginLeft:"2rem"}}>
                                    <div className="name-label">
                                        <div style={{width:"5rem"}}>カナ氏名</div>
                                        <div className="label-value" style={{width:"15rem"}}></div>
                                    </div>
                                    <div className="name-label">
                                        <div style={{width:"5rem"}}>患者氏名</div>
                                        <div className="label-value" style={{width:"15rem"}}></div>
                                    </div>
                                </div>
                                <div style={{marginLeft:"2rem"}}>
                                    <div className="name-label">
                                        <div style={{width:"5rem"}}>生年月日</div>
                                        <div className="label-value" style={{width: "15rem"}}></div>
                                    </div>                                        
                                    <div className="flex">
                                        <div className="name-label">
                                            <div style={{width:"3rem"}}>年齢</div>
                                            <div className="label-value" style={{width: "10rem"}}></div>
                                        </div>
                                        <div className="name-label">
                                            <div style={{width:"3rem",marginLeft:"13px"}}>性別</div>
                                            <div className="label-value" style={{width: "5rem"}}></div>
                                        </div>
                                    </div>
                                </div>                                    
                            </div>                            
                            <div className={'flex'} style={{paddingTop:"10px"}}>
                                ...
                                <div className="ward-list"></div>                            
                                <div className="check-condition" style={{marginLeft:"10px"}}>
                                    <div>出力伝票</div>
                                    <div className="flex">
                                        <div>
                                            <Checkbox
                            ...
                            <div className={'flex display-btn'} style={{paddingTop:"10px"}}>
                                ...
                                <button style={{width:"110px",marginLeft:"20px"}}>全て選択</button>
                                <button style={{width:"110px",marginLeft:"20px"}}>全てクリア</button>
                                <button style={{width:"180px",marginLeft:"20px"}}>未出力分を全て選択</button>
                                <button style={{width:"180px",marginLeft:"20px"}}>出力済分を全て選択</button>                                
                            </div>
                            <div className={'table-area'}>
                                <table className="table-scroll table table-bordered" id="code-table">
                                    ...
                                    <tr>
                                        ...
                                        <th className="td-out">出力</th>
                                        <th className="td-implement-date">実施日</th>
                                        <th className="td-slip">伝票</th>
                                        <th className="td-department">診療科</th>
                                        <th className="td-ward">病棟A</th>
                                        <th className="td-name">患者名</th>
                                        <th className="td-source">材料</th>                                    
                                    </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            return(   
                                                <>
                                                    <tr>
                                                        ...
                                                        <td className="td-out">{item.no}</td>
                                                        <td className="td-implement-date">{item.patient_id}</td>
                                                        <td className="td-slip">{item.name}</td>
                                                        <td className="td-department">{item.sex}</td>
                                                        <td className="td-ward">{item.age}</td>
                                                        <td className="td-name">{item.birthday}</td>
                                                        <td className="td-source">{item.department_name}</td>
                                                    </tr>
                                                </>                                     
                                            );
                                        })}
                    ...
                    <Modal.Footer>
                        ...
                        <Button className="red-btn" onClick={this.props.cancelModal}>参照</Button>
                        <Button className="red-btn" onClick={this.props.cancelModal}>発行</Button>
                    </Modal.Footer>
                </Modal>
            </>
        );
...
WardLabelSlipModal.contextType = Context;
WardLabelSlipModal.propTypes = {
    cancelModal: PropTypes.func,
    patientId: PropTypes.number,
};

export default WardLabelSlipModal;
