...
class HarukaShemaNav extends React.Component {  
  constructor(props) {
    super(props);       
    let zoom = 1;
  ...
  componentDidMount() {
    ...
    // ■1188-151 シェーマでクリック状態のまま描画範囲外に出て戻すと、クリックしていない状態でも線が描かれたり消しゴムなら消される
  ...
  render(){      
    ...
    // console.log("this.props.imgBase64");
    // console.log(this.props.imgBase64);
      ...
      <>        
        <FlexHaruka>                    
                    ...
                    >
                        ...
                        >                          
                          <Layer>
                            {this.state.newImage.src != null && this.state.newImage.src != undefined && this.state.newImage.src != "" && (
                              <ImgBoard src={this.state.newImage.src} width={this.state.view.width} height={this.state.view.height} space="fill"/>
                            )}
...
HarukaShemaNav.propTypes = {      
    imgBase64:PropTypes.string,    
};

export default HarukaShemaNav;
