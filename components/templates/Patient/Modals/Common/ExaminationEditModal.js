...
class ExaminationEditModal extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    <Modal.Title>シェーマ</Modal.Title>
        ...
        <Modal.Footer>
          <Button className='cancel-btn' onClick={this.props.closeModal} style={{paddingTop:'2px', paddingBottom:'2px'}}>キャンセル</Button>
          <Button className='red-btn' style={{paddingTop:'2px', paddingBottom:'2px'}} onClick={this.Insert}>{'登録'}</Button>
        </Modal.Footer>
...
ExaminationEditModal.contextType = Context;

ExaminationEditModal.propTypes = {
...
export default ExaminationEditModal;
