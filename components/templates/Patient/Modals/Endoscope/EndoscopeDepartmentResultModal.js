...
import DepartmentResultPreviewModal
    from "~/components/templates/Patient/Modals/Physiological/DepartmentResultPreviewModal";
        ...
        return (
            <>
                <Modal show={true} className="custom-modal-sm patient-exam-modal first-view-modal inspection-department-result-modal">
                    <Modal.Header><Modal.Title>科別統計（内視鏡検査）</Modal.Title></Modal.Header>
                    <Modal.Body>
                        <Wrapper>
                            <div className={'flex'}>
