...
import EndoscopeListModal from "./EndoscopeListModal";
...
class EndoscopeReservationListModal extends Component {
    constructor(props) {
        super(props);
    ...
    getCondition=async()=>{
        ...
        await apiClient._post(
            ...
            {params: post_data})
            .then((res) => {
                let group_code = res.group_master[0]['group_code'];
                this.setState({
                    group_code,
                    frame_master:res.frame_master[group_code] !== undefined ? res.frame_master[group_code] : [],
    ...
    openEndoscopeListModal=()=>{
        this.setState({
            isEndoscopeListModal:true,
        });
    }
    ...
    render() {
        return (
            <>
                ...
                >
                    <Modal.Header><Modal.Title>内視鏡検査予定一覧</Modal.Title></Modal.Header>
                    <Modal.Body>
                        <Wrapper>
                    ...
                    <Modal.Footer>
                        ...
                        <Button className="red-btn" onClick={this.openEndoscopeListModal}>一覧展開</Button>
                    </Modal.Footer>
                    {this.state.isEndoscopeListModal && (
                        <EndoscopeListModal
...
EndoscopeReservationListModal.contextType = Context;
EndoscopeReservationListModal.propTypes = {
    closeModal: PropTypes.func,
};

export default EndoscopeReservationListModal;
