    ...
    if(order_flag) { // prescription
       order.med.map(medicine => {
        if(!selMedicines.includes(medicine.item_number)) {
          ...
          // if(period_permission == 0 && medicine.end_month !== undefined && medicine.end_month != "") {
       ...
       if(Object.keys(periodData).length > 0) {
        ...
        // this.setState({
        //   periodOrderModal: true,
        //   periodOrderData: periodData,
        //   periodOrder : order,
        // });
        return true;
       }
       ...
       if(Object.keys(periodData).length > 0) {
        ...
        // this.setState({
        //   periodPrescriptionModal: true,
        //   periodPrescriptionData: periodData,
        //   periodPrescription : order,
        // });
        return true;
       }
