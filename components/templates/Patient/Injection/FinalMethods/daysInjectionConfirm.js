...
export default function(number, unit, splitNumbers, usageName, keypressed) {
  ...
  if (changeNumber.indexPres != -1) {
    originalNumber[changeNumber.indexPres].injectDays = number;
    originalNumber[
    ...
    requireBodyParts = originalNumber[changeNumber.indexPres].inject_require_body_parts;
    ...
    if (this.modal_obj.indexOfEditPres != -1) {
      ...
      if (
        originalNumber[this.modal_obj.indexOfEditPres].injectUsageName.includes("ＸＸ")
      ) {
        originalNumber[this.modal_obj.indexOfEditPres].injectDays = 0;
        ...
        originalNumber[this.modal_obj.indexOfEditPres].injectDays = number;
      }

      requireBodyParts = originalNumber[this.modal_obj.indexOfEditPres].inject_require_body_parts;
      indexOfBodyPart = this.modal_obj.indexOfEditPres;

      originalNumber[this.modal_obj.indexOfEditPres].injectUsageName = originalNumber[
        this.modal_obj.indexOfEditPres
      ].injectUsageName.replace("ＸＸ", number);
      ...
      if (
        ...
        // });
        this.modal_obj.injectDaysInitial = 0;
        this.modal_obj.injectDaysLabel = originalNumber[this.modal_obj.indexOfEditPres].injectUsageName;
        this.setState({
          presData: originalNumber
        });
        return;
      ...
      if (originalNumber[this.state.calcNum].injectUsageName.includes("ＸＸ")) {
        originalNumber[this.state.calcNum].injectDays = 0;
        ...
        originalNumber[this.state.calcNum].injectDays = number;
      }

      requireBodyParts = originalNumber[this.state.calcNum].inject_require_body_parts;
      indexOfBodyPart = this.state.calcNum;

      originalNumber[this.state.calcNum].injectUsageName = originalNumber[
        this.state.calcNum
      ].injectUsageName.replace("ＸＸ", number);
      ...
      if (originalNumber[this.state.calcNum].injectUsageName.includes("ＸＸ")) {
        ...
        // });
        this.modal_obj.injectDaysInitial = 0;
        this.modal_obj.injectDaysLabel = originalNumber[this.state.calcNum].injectUsageName;
        this.setState({
  ...
  this.modal_obj.isInjectDaysOpen = false;
  // this.modal_obj.isInjectBodyPartOpen = (requireBodyParts === 1);
  ...
  this.modal_obj.injectDaysInitial = 0;
  this.modal_obj.injectDaysLabel = "";
