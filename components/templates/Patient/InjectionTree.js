...
class InjectionTree extends Component {
    constructor(props) {
        super(props);
        this.state = {
                ...
                <nav>
                    <ul>
                        <li className={this.state.bOpenCurrentOrder?"tree_close":""}>
                            <span onClick={e => this.setOpenClose(e, SOAP_TREE_CATEGORY.CURRENT_ORDER, TREE_FLAG.OPEN_TREE)}><Icon icon={faPlus} />自科注射</span>
                        </li>
                        <li className={this.state.bOpenCurrentOrder?"":"tree_close"}>
                            <span onClick={e => this.setOpenClose(e, SOAP_TREE_CATEGORY.CURRENT_ORDER, TREE_FLAG.CLOSE_TREE)}><Icon icon={faMinus} />自科注射</span>
                            <ul>
                        ...
                        <li className={this.state.bOpenAllOrder?"tree_close":""}>
                            <span onClick={e => this.setOpenClose(e, SOAP_TREE_CATEGORY.ALL_ORDER, TREE_FLAG.OPEN_TREE)}><Icon icon={faPlus} />全科注射</span>
                        </li>
                        <li className={this.state.bOpenAllOrder?"":"tree_close"}>
                            <span onClick={e => this.setOpenClose(e, SOAP_TREE_CATEGORY.ALL_ORDER, TREE_FLAG.CLOSE_TREE)}><Icon icon={faMinus} />全科注射</span>
                            <ul>
...
InjectionTree.contextType = Context;

InjectionTree.propTypes = {
