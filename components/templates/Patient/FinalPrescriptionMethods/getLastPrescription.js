...
export default async function getLastPrescription(patient_id, department_code, karte_status_code=null, department_name=null, target_number=null, param_data=null) {
  if(patient_id > 0){
